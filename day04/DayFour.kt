val out = """pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
...
juo pmiyoh xxk myphio ogfyf dovlmwm moevao qqxidn""".trimMargin();

fun main(args: Array<String>) {
    println( "first question answer is ${com.sendilkumarn.questionOne()}")
    println( "second question answer is ${com.sendilkumarn.questionTwo()}")

}

fun questionOne(): Int {
     return com.sendilkumarn.out.split("\n")
        .map {
            it.split(" ")
                .groupBy { it }
                .mapValues { it.value }
